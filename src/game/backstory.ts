...
export const BACKSTORIES: BackstoryDef[] = [
  {
    ...
    mmoPerk: {
      label: 'De Nabestaanden',
      desc: 'Start met Joris (Meedogenloos) op Beschermingsgeld in Lowrise',
      icon: '🔪',
    },
  ...
  },
  {
    ...
    mmoPerk: {
      label: 'Het Kantoor',
      desc: 'Start met Miriam (Gladjanus) op Straatkoeriers in Lowrise',
      icon: '🎩',
    },
  ...
  },
  {
    ...
    mmoPerk: {
      label: 'De Steeg',
      desc: 'Start met Ayoub (Straatslim) op Straatkoeriers in Lowrise',
      icon: '🎯',
    },
