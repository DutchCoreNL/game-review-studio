...
// ========== AMMO PANEL ==========
// AmmoPanel, KarmaPanel and HpPanel lived here — detail sheets for the ammo, karma and
// HP tiles. Those tiles were removed from the header when the RPG layer was retired, so
// nothing could open them: ammo is not a resource, karma is only moved by story arcs
// that no longer trigger, and HP is not displayed anywhere and nothing drains it.
